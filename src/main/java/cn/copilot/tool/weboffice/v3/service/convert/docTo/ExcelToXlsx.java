package cn.copilot.tool.weboffice.v3.service.convert.docTo;

import cn.copilot.tool.weboffice.v3.exception.InvalidArgument;
import cn.copilot.tool.weboffice.v3.model.convert.ConvertResponse;
import cn.copilot.tool.weboffice.v3.model.convert.OfficeToRequest;
import cn.copilot.tool.weboffice.v3.util.ConvertUtils;
import cn.copilot.tool.weboffice.v3.util.FileUtils;

/**
 * 表格文档转换成 xlsx (Beta)  -> 详见： <br>
 * <a href="https://solution.wps.cn/docs/convert/to-xlsx.html">wps web office 官方文档</a>
 */
public class ExcelToXlsx {
    ...
    public static ConvertResponse convert(OfficeToRequest r) {
        checkUrl(r.getUrl());
        String uri = "/api/developer/v1/office/save/as/xlsx";
    ...
    private static void checkUrl(String url) {
        ...
        FileUtils.typeMatchCheck(FileUtils.excelToXlsxTypes, fileType);
    }
}
